<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('chirps.store') }}">
            ...
            <x-primary-button class="mt-4 font-bold"><strong>{{ __('つぶやく') }}</strong></x-primary-button>
        </form>
        ...
        <div class="mt-6 bg-white shadow-sm rounded-lg divide-y">
            ...
            <div class="p-6 flex space-x-2">
                ...
                @if ($chirp->user->picture)
                <img src="{{ asset($chirp->user->picture) }}" alt="" class="w-12 h-12 mr-4 rounded-full object-cover">
                @endif
                <div class="flex-1">
                    ...
                    <p class="mt-2 text-gray-900">{{ $chirp->message }}</p>
                </div>
            </div>
            @endforeach
        </div>
